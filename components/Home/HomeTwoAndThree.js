    ...
    return (
        ...
        >
            <div className="mr-8 pl-8 md:pl-40">
                ...
                <h1 className="text-lg sm:text-2xl font-semibold text-gradient mt-6">
                ...
                <Link href="/services">
                    <button className="bg-blue-500 hover:bg-blue-600 text-xl sm:text-3xl text-white font-semibold px-8 py-4 mt-8 lg:mt-56 rounded-full">
                        Discover More
                    </button>
                </Link>
            </div>
            <div className="mt-8 sm:mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:mt-10">
                    <div className="bg-white shadow-lg rounded-lg p-8 hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">
                        <h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-4">STRATEGY</h1>
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-8 hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">
                        <h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-4">PLANNING</h1>
                        <p className="text-base sm:text-lg text-gray-700">
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-8 hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">
                        <h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-4">DEVELOPMENT</h1>
                        <p className="text-base sm:text-lg text-gray-700">
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-8 hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">
                        <h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-4">QUICK LAUNCH</h1>
                        <p className="text-base sm:text-lg text-gray-700">
