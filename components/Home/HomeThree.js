    ...
    return (
        <div className="flex flex-col justify-center text-center mb-16 md:mb-32">
            ...
            <p className="text-lg md:text-3xl mt-6 px-4 sm:px-8 lg:px-40">
                ...
                and other organisations with an aim to open up new possibilities for expansion, process automatization, and
                continuous improvement. We are a team of experienced developers, creators, designers and project managers you
                can rely on.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-10">
                <div className="flex flex-col items-center bg-gray-200 rounded-lg p-8 py-20 md:py-36 mt-8 hover:bg-gray-300 transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer">
                    <svg
                        ...
                        strokeWidth="1.5"
                        stroke="currentColor"
                        className="w-12 h-12 sm:w-20 sm:h-20 mb-4"
                    >
